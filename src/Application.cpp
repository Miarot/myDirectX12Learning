...
constexpr wchar_t WINDOW_CLASS_NAME[] = L"MySyperWindowClass";
...
ComPtr<ID3D12DescriptorHeap> Application::CreateDescriptorHeap(
    ...
    D3D12_DESCRIPTOR_HEAP_TYPE type)
{
    ...
    ThrowIfFailed(m_d3d12Device->CreateDescriptorHeap(&desc, IID_PPV_ARGS(&descriptroHeap)));
